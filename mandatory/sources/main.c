...
/*   Updated: 2025/06/02 19:08:04 by mmilliot         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/*
    The main function is the entry point of the Cub3D program.
    It validates arguments, loads and parses the map file, checks all data
    validity, then initializes and starts the graphics engine.
*/

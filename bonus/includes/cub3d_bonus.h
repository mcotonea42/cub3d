...
/*   Updated: 2025/06/02 16:38:18 by mcotonea         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/* Structure for the textures infos */
...
/* Structure for get the informations of the map */
...
/* Structure for gather all of the data */
...
void			load_texture(t_data *data, void *mlx,
					t_texture *tex, char *path);

int				check_xpm_extension(char *file);
int				is_valid_file(char *file);
void			check_bonus_textures(t_data *data);

/* Functions for Quit cleanly the program */
void			destroy_all(t_data *data);
void			free_all(t_data *data);
int				exit_error(t_data *data, char *str);
int				exit_success(t_data *data);

/* Functions for create and Display the game */
...
void			print_door_or_wall(t_data *data,
					t_fov *fov, int screen_x, int y);
void			setup_wall_render_info(t_data *data, t_fov *fov,
					t_render_infos *info);
void			setup_door_render_info(t_data *data, t_fov *fov,
					t_render_infos *info);
...
void			print_crosshair(t_data *data, t_display *display,
					t_crosshair *cross);
void			init_doors(t_data *data);
void			handle_door_animation(t_data *data);
void			update_door_animations(t_data *data);
int				detecte_door(t_data *data, t_fov *fov);
void			wall_colision(t_data *data, t_fov *fov,
					t_player *player);
void			door_colision(t_data *data, t_fov *fov,

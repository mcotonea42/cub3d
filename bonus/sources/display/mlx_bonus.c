...
/*   Updated: 2025/06/02 18:20:38 by mmilliot         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/*
    ...
    It handles mouse input, updates the player's position, draws the main
    scene, and displays it in the window. This keeps the game running and
    updating smoothly.
*/
...
/*
    ...
    It sets up the main scene image, player, and loads all bonus images.
...
void	create_game(t_data *data)
{
	...
	load_texture(data, data->mlx_c, &data->door_side, IMG_SIDE_DOOR);

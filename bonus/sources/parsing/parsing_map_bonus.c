...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/06/02 18:23:05 by mcotonea          #+#    #+#             */
/*   Updated: 2025/06/02 18:23:11 by mcotonea         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static int	get_player_orientation(t_data *data,
...
void	check_map(t_data *data)
{
	...
	if (!check_walls_around_door(data->mapinfo.map,
			data->mapinfo.height, data->mapinfo.width))
		exit_error(data, ERR_DOOR);
